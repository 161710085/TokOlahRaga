<style>
     ...
     <footer class="footer-distributed">
        <div class="footer-left">
                <img src="{{asset('fe/img/core-img/logos.png')}}" style="width: 500px" alt=""></a>

           <p class="footer-company-name">Kopo Sport &copy; 2019</p>
        </div>
        <div class="footer-center">
           <div>
              <i class="fa fa-map-marker"></i>                     
              <p><span> Jl. Kopo Bihbul No.161, Babakan Asih, </span> Bojongloa Kaler, Kota Bandung, Jawa Barat 40225</p>
           </div>
           <div>
           ...
           <div>
              ...
              <p><a href="mailto:thiajanwar@gmail.com">thiajanwar@gmail.com</a></p>
           </div>
        </div>
        <div class="footer-right">
           <p class="footer-company-about">                     <span>Tentang Kami</span> Kopo Sport can be found at Jl Kopo Bihbul 161 . The following is offered: Sporting Goods . In Bandung there are 1 other Sporting Goods. An overview can be found here.     </p>
