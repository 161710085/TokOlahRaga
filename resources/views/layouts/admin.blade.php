            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li><a data-toggle="tab" href="#mailbox"><i class="notika-icon notika-mail"></i> Barang</a>
                        </li>
                        <li><a data-toggle="tab" href="#Interface"><i class="notika-icon notika-edit"></i> Blog</a>
                        </li>
                    ...
                    <div class="tab-content custom-menu-content">
                        ...
                        <div id="mailbox" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><a href="{{route('barang.index')}}">Barang</a>
                                </li>
                                <li><a href="{{route('kategori.index')}}">Kategori Barang</a>
                                </li>
                                <li><a href="{{route('merk.index')}}">Merk Barang</a>
                                </li>
                        ...
                        <div id="Interface" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                              ...
                              <li><a href="{{route('berita.index')}}">Blog</a>
